...
## Общее описание
Целью работы является реализация иерархии generic структур данных на основе деревьев поис
Все реализации должны соответствовать принципам SOLID и использовать паттерны проектирования.
